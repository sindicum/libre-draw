...
| [`ModeName`](/api/types#modename)                                                                                                                                                                                                                                 | `'idle' \| 'draw-point' \| 'draw-line' \| 'draw-polygon' \| 'draw-rectangle' \| 'draw-angled-rectangle' \| 'select' \| 'split' \| 'union' \| 'setback' \| 'rotate'` |
...
| `CreateEvent`, `UpdateEvent`, `DeleteEvent`, `SplitEvent`, `SplitFailedEvent`, `SetbackEvent`, `SetbackFailedEvent`, `UnionEvent`, `UnionFailedEvent`, `CutEvent`, `CutFailedEvent`, `RotateEvent`, `SelectionChangeEvent`, `ModeChangeEvent`, `DraftChangeEvent` | Event payloads, see [Events](/api/events)                                                                                                                           |
| [`SplitFailReason`](/api/events#splitfailed), [`SetbackFailReason`](/api/events#setbackfailed), [`UnionFailReason`](/api/events#unionfailed), [`CutFailReason`](/api/events#cutfailed)                                                                            | Failure reasons carried by the `*failed` events                                                                                                                     |
...
| [`cut`](/api/events#cut)                         | `CutEvent`             | Area cut out of a polygon                 |
| [`cutfailed`](/api/events#cutfailed)             | `CutFailedEvent`       | Cut operation failed                      |
